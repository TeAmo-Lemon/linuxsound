...
{
	// printk("pcm.h snd_pcm_uframes_t");
...
{
	printk("pcm.h snd_pcm_capture_ready-_______-");
	struct snd_pcm_runtime *runtime = substream->runtime;
...
static inline int snd_pcm_playback_data(struct snd_pcm_substream *substream)
{
    ...
    printk("pcm.h snd_pcm_playback_data buffer_size: %lu\n", runtime->buffer_size);
...
{
	printk("pcm.h snd_pcm_playback_empty");
	struct snd_pcm_runtime *runtime = substream->runtime;
	return snd_pcm_playback_avail(runtime) >= runtime->buffer_size;
}
...
/**
 * params_period_size - Get the period size (in frames) from the hw paramspcm_uframes_t
 * @p: hw params
 */
...
{
	printk("pcm.h sumd_pcm_lib_write");
...
{
	printk("pcm.h sumd_pcm_lib_read");
	return __snd_pcm_lib_xfer(substream, (void __force *)buf, true, frames, false);
}
...
{
	printk("pcm.h sumd_pcm_lib_writev");
...
snd_pcm_lib_readv(struct snd_pcm_substream *substream,
		  void __user **bufs, snd_pcm_uframes_t frames)
{
	printk("pcm.h sumd_pcm_lib_readv");
	return __snd_pcm_lib_xfer(substream, (void *)bufs, false, frames, false);
}
...
{
	printk("pcm.h snd_pcm_kernel_write");
...
{
	printk("pcm.h snd_pcm_kernel_read");
...
{
	printk("pcm.h snd_pcm_kernel_writev");	
...
snd_pcm_kernel_readv(struct snd_pcm_substream *substream,
		     void **bufs, snd_pcm_uframes_t frames)
{
	printk("pcm.h snd_pcm_kernel_readv");	
	return __snd_pcm_lib_xfer(substream, bufs, false, frames, true);
}
...
{
	printk("pcm.h snd_pcm_set_fixed_buffer");
...
snd_pcm_set_fixed_buffer_all(struct snd_pcm *pcm, int type,
			     struct device *data, size_t size)
{
	printk("pcm.h snd_pcm_set_fixed_buffer_all");
...
{
	printk("pcm.h snd_pcm_mmap_data_open");
...
{
	printk("pcm.h snd_pcm_mmap_data_close");
	struct snd_pcm_substream *substream = (struct snd_pcm_substream *)area->vm_private_data;
